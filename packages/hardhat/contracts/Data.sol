...
library Data {
  ...
  function generateSVGofTokenById(address owner, uint256 tokenId, uint256 color) internal pure returns (string memory) {
  ...
  function tokenURI(address owner, uint256 tokenId, uint256 color) internal pure returns (string memory) {

      string memory name = string(abi.encodePacked('Petal #',tokenId.toString()));
      string memory description = string(abi.encodePacked('This Petal is the color #',color,'!!!'));
